    ...
    public function run()
    {
        ...
        if (!$dataType->exists) {
            $dataType->fill([
                ...
                'icon'                  => 'voyager-list',
                'model_name'            => 'YellowThree\\Voyager\\Models\\Menu',
                'controller'            => '',
                'generate_permissions'  => 1,
                'description'           => '',
            ])->save();
        ...
        if (!$dataType->exists) {
            $dataType->fill([
                ...
                'icon'                  => 'voyager-lock',
                'model_name'            => 'YellowThree\\Voyager\\Models\\Role',
                'controller'            => 'YellowThree\\Voyager\\Http\\Controllers\\VoyagerRoleController',
                'generate_permissions'  => 1,
                'description'           => '',
            ])->save();
        }
