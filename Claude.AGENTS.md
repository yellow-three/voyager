...
| Test | PHPUnit ^11.0 + orchestra/testbench ^11.0 |
...
# Test suite
./vendor/bin/phpunit
./vendor/bin/phpunit --filter=BreadTableTest
...
Scope ornekleri: `bread-table`, `bread-form`, `media-manager`, `plugin-system`, `theme-system`, `deps`, `vite`, `tailwind`, `tests`, `cli-generator`, `model-registry`, `e2e`, `ci`, `docs`, `namespace`
...
1. Bu proje bir **Laravel paketidir**, uygulama degil. `orchestra/testbench ^11.0` ile test edilir.
