...
new class extends Component {
    ...
    public function loadSettings(): void
    {
        ...
        // Default activeGroup to the first available group or 'Site'
        $groups = $this->groups;
    ...
    public function save(): void
    {
        foreach ($this->settings as $settingData) {
            ...
            // Handle file upload fields separately if they are uploaded
        ...
        $this->uploadedFiles = [];
        $this->loadSettings();
        session()->flash('message', __('voyager::settings.successfully_saved') ?? 'Settings successfully saved.');
    }
    ...
    public function addSetting(): void
    {
        ...
        $setting = Voyager::model('Setting')::create([
            'key' => $this->newKey,
        ...
        $this->loadSettings();
        session()->flash('message', __('voyager::settings.successfully_created') ?? 'Setting successfully created.');
    }
