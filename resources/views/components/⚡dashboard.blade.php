...
new class extends Component {
    ...
    {
        // Load basic counts safely
        $this->metrics = [
            [
                'title' => __('voyager::generic.users') ?? 'Users',
            ...
            [
                'title' => __('voyager::generic.roles') ?? 'Roles',
            ...
            [
                'title' => __('voyager::generic.settings') ?? 'Settings',
        ...
        // Safe fetch of recent actions/activities if ActivityLog or standard logs exists
        $this->activities = [
            ['description' => 'Logged into Admin Panel', 'time' => 'Just now', 'type' => 'info'],
            ['description' => 'Checked system status', 'time' => '5 mins ago', 'type' => 'success'],
        ];
    }
